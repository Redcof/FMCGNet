...
def train_one_batch(model, images, labels, optimizer, criterion_class_loss):
    optimizer.zero_grad()
...
def train_one_epoch(opt, writer, epoch_idx, num_epoch, model, meta_dict, train_loader, optimizer, criterion_class_loss):
...
def train_loop(opt, classes, writer, train_loader, test_loader, val_loader):
    ...
    for epoch_idx in range(num_epochs):
        ...
        # train
        train_one_epoch(opt, writer, epoch_idx, num_epochs, net, meta_dict, train_loader, optimizer,
