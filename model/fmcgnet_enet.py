...
class TerminalBlock(nn.Module):
    """The terminal block is composed of two heads:
    1. a bounding box regression head
    2. a object classification head
...
class DilatedBottleneck(RegularBottleneck):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)


class DeformableBottleneck(RegularBottleneck):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
